...
\begin{itemize}[nosep,leftmargin=1.6em]
    ...
    \item 大学物理(甲)Ⅱ \hfill 93/100（4.8/5.0）
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}: https://github.com/QSCTech/Enroll_nx{GitHub仓库} | https://mp.weixin.qq.com/s/OQEG9Q_kLU5yGWZcwtYdmA{功能介绍}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}: https://taoists.com.cn/{在线网站} | https://github.com/zjuatri/taoist_school_web {GitHub仓库}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}:  https://github.com/zjuwangrui/wuziqi{GitHub仓库}
\end{itemize}
