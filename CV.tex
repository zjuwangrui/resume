...
\begin{itemize}[nosep,leftmargin=1.6em]
    \item 线性代数 \hfill 97/100（5.0/5.0）
    \item 微积分 \hfill 97/100（5.0/5.0）
    \item 大学物理(甲)2 \hfill 93/100（4.8/5.0）
    \item C语言程序设计基础及实验 \hfill 92/100（4.8/5.0）
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}: \url{https://github.com/QSCTech/Enroll_nx}{GitHub仓库} | \url{https://mp.weixin.qq.com/s/OQEG9Q_kLU5yGWZcwtYdmA}{功能介绍}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}: \url{https://taoists.com.cn/}{在线网站} | \url{https://github.com/zjuatri/taoist_school_web}{GitHub仓库}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}:  \url{https://github.com/zjuwangrui/wuziqi}{GitHub仓库}
\end{itemize}
