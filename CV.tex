...
信息工程\quad 大二 
\begin{itemize}[nosep]
    \item 相关课程：线性代数(97)、C语言程序设计基础及实验(92)
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}：\href{https://github.com/QSCTech/Enroll_nx}{GitHub仓库} | \href{https://mp.weixin.qq.com/s/OQEG9Q_kLU5yGWZcwtYdmA}{功能介绍}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}:\href{https://taoists.com.cn/}{在线网站} | \href{https://github.com/zjuatri/taoist_school_web}{GitHub仓库}
\end{itemize}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{相关链接}：\href{https://github.com/zjuwangrui/wuziqi}{GitHub仓库}
\end{itemize}

\section{\makebox[\widthof{\faCogs}][c]{\color{CVBlue}\faCogs}\ 技术栈}
\begin{itemize}[nosep]
    \item \textbf{编程语言：} \textbf{JavaScript},  HTML/CSS
    \item \textbf{前端框架：} \textbf{Vue.js}, React.js
